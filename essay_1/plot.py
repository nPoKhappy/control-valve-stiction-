...
def plot_pv_sp_op( pv: np.ndarray,sp: np.ndarray ,op: np.ndarray) -> None:
    ...
    # plt.subplot(2, 1, 1)
    # plt.plot(samples, sp, label="Setpoint", color="g")
    ...
    plt.title("CO of specific control loops.")
...
if __name__ == "__main__":
    ...
    plot_pv_sp_op(pv=pv_loop, sp=sp_loop, op=op_loop)
